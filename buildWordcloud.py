...
def get_text_from_html(filename):
    ...
    chats = re.findall(
        '<pre style=\"white-space\:pre\-wrap\;\*white-space\:pre\;\*word\-wrap\:break\-word\;\">(.*?)</pre>', content)
...
def draw_pic_with_frequences(frequences, pic_path, maxfontsize=400, fontpath='MSYH.TTC'):
    '''
...
frequences = get_keywords_from_text(text, 500)
